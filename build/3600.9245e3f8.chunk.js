"use strict";(self.webpackChunkbranchtest_1=self.webpackChunkbranchtest_1||[]).push([[3600],{20894:(h,M,s)=>{s.d(M,{B:()=>U,D:()=>I,H:()=>K,R:()=>A});var t=s(19968),l=s(48936),d=s(63358),O=s(20596),P=s(48112),g=s(42816),m=s(28464),a=s(79632),e=s(14520),o=s(15396),E=s(14632),c=s(94248),C=s(1844),r=s(5596);const D=(0,r.cp)(l.C)`
  svg path {
