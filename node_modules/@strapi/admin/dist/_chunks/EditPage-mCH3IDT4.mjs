...
import { p as useEnterprise, j as useTypedSelector, x as isBaseQueryError } from "./index-rZLvYBJ8.mjs";
...
import { u as useWebhooks } from "./useWebhooks-y9tdiVKX.mjs";
...
const WebhookForm = ({
  ...
  const EventTable = useEnterprise(
    EventTableCE,
    async () => (await import("./EventsTable-KCZ9Pb4n.mjs")).EventsTableEE
  );
...
//# sourceMappingURL=EditPage-mCH3IDT4.mjs.map
