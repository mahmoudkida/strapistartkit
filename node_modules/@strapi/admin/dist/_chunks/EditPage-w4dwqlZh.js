...
const useWebhooks = require("./useWebhooks-L5crY_WV.js");
...
const WebhookForm = ({
  ...
  const EventTable = index.useEnterprise(
    EventTableCE,
    async () => (await Promise.resolve().then(() => require("./EventsTable-CfFE47U7.js"))).EventsTableEE
  );
...
//# sourceMappingURL=EditPage-w4dwqlZh.js.map
