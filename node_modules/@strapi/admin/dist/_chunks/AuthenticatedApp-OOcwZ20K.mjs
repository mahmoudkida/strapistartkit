...
import { u as useConfiguration, a as useAuth, c as createTypedSelector, b as useOnce, d as createRoute, e as useInformationQuery, f as useGetMyPermissionsQuery, R as RBACProvider, N as NpsSurvey } from "./index-rZLvYBJ8.mjs";
...
const dependencies = {
  ...
  "@strapi/icons": "1.14.1",
  "@strapi/permissions": "4.19.0",
  "@strapi/provider-audit-logs-local": "4.19.0",
  "@strapi/types": "4.19.0",
  "@strapi/typescript-utils": "4.19.0",
  "@strapi/utils": "4.19.0",
...
const devDependencies = {
  ...
  "@strapi/data-transfer": "4.19.0",
  "@strapi/pack-up": "4.19.0",
  "@strapi/plugin-content-manager": "4.19.0",
...
const CM = React.lazy(
  () => import("./index-rZLvYBJ8.mjs").then((n) => n.a0).then((mod) => ({ default: mod.App }))
);
const HomePage = React.lazy(
  () => import("./HomePage-GUFRYUDo.mjs").then((mod) => ({
    default: mod.HomePage
  }))
);
const InstalledPluginsPage = React.lazy(
  () => import("./InstalledPluginsPage-2cTbV33R.mjs").then((mod) => ({
    default: mod.ProtectedInstalledPluginsPage
  }))
);
const MarketplacePage = React.lazy(
  () => import("./MarketplacePage-s3q3AP3I.mjs").then((mod) => ({ default: mod.ProtectedMarketplacePage }))
);
const NotFoundPage = React.lazy(
  () => import("./index-rZLvYBJ8.mjs").then((n) => n.$).then(({ NotFoundPage: NotFoundPage2 }) => ({ default: NotFoundPage2 }))
);
...
const ProfilePage = React.lazy(
  () => import("./ProfilePage-qL4I2aww.mjs").then((mod) => ({
    default: mod.ProfilePage
  }))
);
const SettingsPage = React.lazy(
  () => import("./SettingsPage-GEaBCr73.mjs").then((mod) => ({
...
//# sourceMappingURL=AuthenticatedApp-OOcwZ20K.mjs.map
