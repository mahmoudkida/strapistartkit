...
const dependencies = {
  ...
  "@strapi/icons": "1.14.1",
  "@strapi/provider-upload-local": "4.19.0",
  "@strapi/utils": "4.19.0",
  axios: "1.6.0",
  "byte-size": "7.0.1",
  cropperjs: "1.6.0",
...
const index = {
  register(app) {
    app.addMenuLink({
      ...
      async Component() {
        const component = await Promise.resolve().then(() => require("./index-ap8wPlAK.js"));
        return component;
      }
    });
  ...
  bootstrap(app) {
    app.addSettingsLink("global", {
      ...
      async Component() {
        const component = await Promise.resolve().then(() => require("./index-rpbXb_Uj.js"));
        return component;
      },
...
//# sourceMappingURL=index--QO6mnQ4.js.map
