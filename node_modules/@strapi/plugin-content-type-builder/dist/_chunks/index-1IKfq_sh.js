...
const index$1 = require("./index-DLOZMIJc.js");
...
const ListView$1 = React.lazy(() => Promise.resolve().then(() => require("./ListView-mOPeearP.js")));
const RecursivePath = () => {
...
const ListView = React.lazy(() => Promise.resolve().then(() => require("./ListView-mOPeearP.js")));
const App = () => {
  const { formatMessage } = reactIntl.useIntl();
...
//# sourceMappingURL=index-1IKfq_sh.js.map
