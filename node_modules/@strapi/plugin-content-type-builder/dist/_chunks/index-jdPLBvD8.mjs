...
const ListView$1 = lazy(() => import("./ListView-B4oXNssc.mjs"));
const RecursivePath = () => {
...
const ListView = lazy(() => import("./ListView-B4oXNssc.mjs"));
const App = () => {
  const { formatMessage } = useIntl();
...
//# sourceMappingURL=index-jdPLBvD8.mjs.map
